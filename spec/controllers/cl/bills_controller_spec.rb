...
describe Cl::BillsController do
  ...
  # Cl::BillsController. Be sure to keep this updated too.
  def valid_session
    {}
  end
  ...
  describe "filter_conditions" do
    it "passes 'q' params" do
      conditions = {"q" => "Pena"}
      filtered_conditions = Cl::BillsController.new.filter_conditions(conditions)
    ...
    context "with bill attributes as params" do
      it "passes bill attributes" do
        ...
        attr1, attr2 = (Cl::Bill.attribute_names - mongoid_attribute_names)[0..1]
  ...
  describe "GET show" do
    ...
    describe "with non existent id" do
      it "returns a 404" do
        bill = FactoryGirl.create(:cl_bill1)
        @bill3 = FactoryGirl.attributes_for(:cl_bill3)
  ...
  describe "GET search" do
    ...
    before(:each) do
      ...
      @bill2 = FactoryGirl.create(:cl_bill2)
      @bill3 = FactoryGirl.create(:cl_bill3)
      @bill4 = FactoryGirl.create(:cl_bill4)
    ...
    context "doing a simple 'q' query" do
      ...
      context "with multiple results" do
        ...
        it "boosts results for fields: tag, subject_areas, title and abstract, in that order" do
          bill1 = FactoryGirl.create(:cl_bill, uid: 1, abstract: "term")
          bill2 = FactoryGirl.create(:cl_bill, uid: 2, title: "term")
          bill3 = FactoryGirl.create(:cl_bill, uid: 3, subject_areas: ["term"])
          bill4 = FactoryGirl.create(:cl_bill, uid: 4, tags: ["term"])
          Sunspot.remove_all(Bill)
          Sunspot.index!(Bill.all)
    ...
    context "advanced query" do
      ...
      it "searches by priorities" do
        ...
        priority1 = FactoryGirl.create(:cl_priority1, type: "Simple", entry_date: Date.today - 1)
        priority2 = FactoryGirl.create(:cl_priority1, type: "Discusión inmediata", entry_date: Date.today - 1)
        priority3 = FactoryGirl.create(:cl_priority1, type: "Suma", entry_date: Date.today - 1)
        priority4 = FactoryGirl.create(:cl_priority1, type: "Discusión inmediata", entry_date: Date.today - 1)
  ...
  describe "PUT update" do
    ...
    describe "with valid params" do
      it "updates the requested bill" do
        bill = FactoryGirl.create(:cl_bill1)
        bill_new_attrs = FactoryGirl.attributes_for(:cl_bill3)
